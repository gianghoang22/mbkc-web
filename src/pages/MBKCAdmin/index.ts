export { default as MBKCAdminDashboardPage } from './dashboard/MBKCAdminDashboardPage';
//
...
export { default as KitchenCenterDetailPageSkeleton } from './kitchenCenter/KitchenCenterDetailPageSkeleton';
