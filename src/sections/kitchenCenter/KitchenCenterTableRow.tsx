...
interface KitchenCenterTableRowProps {
  handleNavigateDetail: (kitchenCenterId: number) => void;
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} key={kitchenCenter.title} sx={{ cursor: 'pointer' }}>
        <TableCell width={60} align="center" onClick={() => handleNavigateDetail(kitchenCenter.kitchenCenterId)}>
          {index + 1}
        </TableCell>
        <TableCell
          component="th"
          scope="row"
          padding="none"
          onClick={() => handleNavigateDetail(kitchenCenter.kitchenCenterId)}
        >
        ...
        <TableCell align="left" onClick={() => handleNavigateDetail(kitchenCenter.kitchenCenterId)}>
