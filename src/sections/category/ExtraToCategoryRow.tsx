    ...
    <>
      ...
      {isOpen && (
        <ConfirmDialog
          ...
          title={translate('dialog.confirmDeleteTitle', { model: translate('sidebar.extraCategory') })}
          description={translate('dialog.confirmDeleteContent', { model: translate('sidebar.extraCategory') })}
        />
      )}
    </>
  );
