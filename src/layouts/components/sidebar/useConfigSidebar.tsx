...
function useConfigSidebar() {
  ...
  const navBrand: NavSection[] = [
    {
      missions: translate('model.overview'),
      listNav: [
        {
          title: translate('model.dashboard'),
          path: PATH_BRAND_APP.root,
          icon: <AssessmentIcon fontSize="medium" />,
        },
        {
          title: translate('model.information'),
  ...
  const navCashier: NavSection[] = [
    ...
    },
    {
      ...
      listNav: [
        ...
        {
          title: translate('model.transaction'),
