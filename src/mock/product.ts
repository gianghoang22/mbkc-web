...
const products = [...Array(24)].map((_, index) => ({
  ...
  historicalPrice: faker.datatype.number({ min: 10000, max: 1000000 }),
  sellingPrice: faker.datatype.number({ min: 10000, max: 1000000 }),
  discountPrice: faker.datatype.number({ min: 10000, max: 1000000 }),
  size: 'S, M, L',
